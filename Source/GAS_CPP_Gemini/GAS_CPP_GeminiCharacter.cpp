...
AGAS_CPP_GeminiCharacter::AGAS_CPP_GeminiCharacter()
{
	...
	static ConstructorHelpers::FClassFinder<UGeminiAttributeDebugWidget> WidgetClassFinder(TEXT("/Game/UI/WBP_AttributeDebug"));
...
void AGAS_CPP_GeminiCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AGAS_CPP_GeminiCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AGAS_CPP_GeminiCharacter::Look);
	}
	else
	{
...
void AGAS_CPP_GeminiCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
